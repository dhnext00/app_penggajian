    ...
    <tr>
        ...
        <td>
            <center>
                ...
                <a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/dataPegawai/deleteData/'.$p->id_pegawai) ?>"><i class="fas fa-trash"></i></a>
            </center>
        </td>
    </tr>
<?php endforeach; ?>
