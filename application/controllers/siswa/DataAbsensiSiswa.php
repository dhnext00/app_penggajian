...
class DataAbsensiSiswa extends CI_Controller{
    ...
    public function index()
    {
        ...
        $data['absensi'] = $this->db->query("SELECT data_siswa.nama_siswa,data_siswa.nis,data_sekolah.nama_sekolah,data_sekolah.alamat_sekolah,data_sekolah.tahun_ajaran,data_kehadiran.bulan,data_kehadiran.id_kehadiran
            FROM data_siswa
    ...
    public function cetakAbsensi($id)
    {
        ...
        $data['print_slip'] = $this->db->query("SELECT data_siswa.nis,data_siswa.nama_siswa,data_sekolah.nama_sekolah,data_sekolah.alamat_sekolah,data_sekolah.tahun_ajaran,data_kehadiran.bulan
            FROM data_siswa
            INNER JOIN data_kehadiran ON data_kehadiran.nis=data_siswa.nis
            INNER JOIN data_sekolah ON data_sekolah.nama_sekolah=data_siswa.sekolah
